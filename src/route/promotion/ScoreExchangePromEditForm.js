      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem hasFeedback {...formItemLayout} label="红包参数">
          {getFieldDecorator("gifts", {
            rules: [{ type: 'array', required: true, message: '请输入兑换礼品'}],
            initialValue: promotion.awards.gifts
          })(
            <GiftsInput disabled={true} />
          )}
        </FormItem>
...
const ScoreExchangePromEditForm = Form.create()(EditForm)
...
export default connect(mapStateToProps, mapDispatchToProps)(ScoreExchangePromEditForm)
